...
export const Contact = () => {
  ...
  return (
    <section id="contact" className="py-24 px-4 bg-gradient-to-br from-blue-50/50 via-white to-purple-50/50 dark:from-blue-950/30 dark:via-slate-900 dark:to-purple-950/30 relative">
          ...
          <div className="space-y-4">
            ...
            <div className="glass-card p-6 hover:shadow-lg transition-all duration-300">
              ...
              <div className="space-y-2">
                <p className="text-gray-700 dark:text-gray-300">New York City, NY</p>
                ...
                <div className="aspect-video bg-gray-100 dark:bg-gray-800 rounded-lg overflow-hidden mt-3">
                  <iframe
                    ...
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d193595.15830899444!2d-74.11976379633864!3d40.69766374873451!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c24fa5d33f083b%3A0xc80b8f06e177fe62!2sNew%20York%2C%20NY!5e0!3m2!1sen!2sus!4v1681147478527!5m2!1sen!2sus"
                    width="100%"
                    height="100%"
                    style={{ border: 0 }}
                    allowFullScreen
            ...
            <div className="glass-card p-6 hover:shadow-lg transition-all duration-300">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center">
                  ...
                  <span>Mon - Fri, 9:00 - 17:00 EST</span>
                </div>
              </div>
            </div>
            ...
            <div className="glass-card p-6 hover:shadow-lg transition-all duration-300">
              ...
              <div className="mt-4 flex flex-col items-center">
                <p className="text-sm text-gray-500 mb-2">Scan for digital resume</p>
                ...
                <a 
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="mt-2 text-primary hover:underline text-sm inline-flex items-center"
                >
